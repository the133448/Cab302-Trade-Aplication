...
class OrganisationResourceIT {
    ...
    private static final Integer DEFAULT_BUY_ORDER_CREDITS = 1;
    private static final Integer UPDATED_BUY_ORDER_CREDITS = 2;
    ...
    public static Organisation createEntity(EntityManager em) {
        Organisation organisation = new Organisation()
            ...
            .buyOrderCredits(DEFAULT_BUY_ORDER_CREDITS);
        return organisation;
    }
    ...
    public static Organisation createUpdatedEntity(EntityManager em) {
        Organisation organisation = new Organisation()
            ...
            .buyOrderCredits(UPDATED_BUY_ORDER_CREDITS);
        return organisation;
    }
    ...
    void createOrganisation() throws Exception {
        ...
        assertThat(testOrganisation.getCredits()).isEqualTo(DEFAULT_CREDITS);
        assertThat(testOrganisation.getBuyOrderCredits()).isEqualTo(DEFAULT_BUY_ORDER_CREDITS);
    }
    ...
    void getAllOrganisations() throws Exception {
        ...
        restOrganisationMockMvc
            ...
            .andExpect(jsonPath("$.[*].buyOrderCredits").value(hasItem(DEFAULT_BUY_ORDER_CREDITS)));
    }
    ...
    void getOrganisation() throws Exception {
        ...
        restOrganisationMockMvc
            ...
            .andExpect(jsonPath("$.buyOrderCredits").value(DEFAULT_BUY_ORDER_CREDITS));
    }
    ...
    void putNewOrganisation() throws Exception {
        ...
        updatedOrganisation.name(UPDATED_NAME).credits(UPDATED_CREDITS).buyOrderCredits(UPDATED_BUY_ORDER_CREDITS);
        ...
        assertThat(testOrganisation.getCredits()).isEqualTo(UPDATED_CREDITS);
        assertThat(testOrganisation.getBuyOrderCredits()).isEqualTo(UPDATED_BUY_ORDER_CREDITS);
    }
    ...
    void fullUpdateOrganisationWithPatch() throws Exception {
        ...
        partialUpdatedOrganisation.name(UPDATED_NAME).credits(UPDATED_CREDITS).buyOrderCredits(UPDATED_BUY_ORDER_CREDITS);
